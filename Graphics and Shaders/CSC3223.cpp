...
RenderObject* Tutorial13(Renderer& renderer) {
	...
	TextureBase * tex = OGLTexture::RGBATextureFromFilename("garfield.PNG");
...
void Tutorial12(Renderer& renderer) {
	...
	TextureBase * noiseTex = OGLTexture::RGBATextureFromFilename("jon.PNG");
...
void Tutorial11(Renderer& renderer) {
	...
	object -> SetBaseTexture(OGLTexture::RGBATextureFromFilename("jon.png"));
...
void Tutorial2(Renderer & renderer) {
	...
	OGLMesh * rasterTri = (OGLMesh *)RasterisationMesh::CreateTriangleFromPoints({ Vector3(550 ,400 ,0) , Vector3(750 ,380 ,0) , Vector3(650 ,300 ,0) }, { Vector4(1, 0, 0, 1), Vector4(0, 1, 0, 1), Vector4(0, 0, 1, 1) });
